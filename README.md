...
The repository currently contains an import-safe protocol scaffold, synthetic ingestion that preserves guideline/page provenance, cited lexical retrieval capped at three passages, a deterministic interaction fixture, an approved dependency manifest, and offline tests. The manifest is recorded for later environment setup and has not been installed or resolved in these milestones.
